        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>Effects are used to trugger certain actions based upon changes to a component</li>
...
const SampleEffect = () => {
    ...
    <button onClick={buttonHandler}>Clickme to start an effect in the console</button>
    return(
